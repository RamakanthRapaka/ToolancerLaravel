                    ...
                    <div class="tabs">
                        <div class="col-10 m-auto">
                            <div class="row justify-content-start">
                                <div class="col-lg-4 col-sm-6 col-sm-6 all ai">
                                    <div class="colWidget">
                                        <div class="card p-3">
                                            ...
                                            <div class="col-12">
                                                <a class="arrowLink d-block text-center" href="export-view.php">Hire
                                                    Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-sm-6 all ai automation">
                                    <div class="colWidget">
                                        <div class="card p-3">
                                            <div class="cardRow d-flex align-items-center">
                                                <div class="cardImg"><img
                                ...
                                <div class="col-lg-4 col-sm-6 col-sm-6 all analytics">
                                    <div class="colWidget">
                                        <div class="card p-3">
                                            <div class="cardRow d-flex align-items-center">
                                                <div class="cardImg"><img
                                                ...
                                                <div class="card p-3">
                                                    <div class="cardRow d-flex align-items-center">
                                                        ...
                                                        <div class="align-self-start">
                                                            <span class="badge rounded-pill text-grey topbadge">Price-
                                                                450/hr</span>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-end mt-3">
                                                        <a class="arrowLink" href="tool-view.php">Hire Details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
